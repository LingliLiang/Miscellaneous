...
namespace DirectUI
{
	...
	<Attribute name="vtype" default="0" type="INT" comment="数据类型, 0-原始 1-INT 2-double"/>
	<Attribute name="value" default="0" type="INT,DOUBLE" comment="数据类型值, 如(1或1.00)"/>
